...
<head>
    ...
    <link rel="shortcut icon" type="image/png"
        href="{{ asset('storage/backend-resources/images/favicon.png">') }}
    <link href="{{ asset('storage/backend-resources/vendor/wow-master/css/libs/animate.css') }}"
        rel="stylesheet">

    <link href="{{ asset('storage/backend-resources/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}"
        rel="stylesheet">
    <link rel="stylesheet"
        href="{{ asset('storage/backend-resources/vendor/bootstrap-select-country/css/bootstrap-select-country.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('storage/backend-resources/vendor/jquery-nice-select/css/nice-select.css') }}">
    <link href="{{ asset('storage/backend-resources/vendor/datepicker/css/bootstrap-datepicker.min.css') }}"
        rel="stylesheet">

    <link href="{{ asset('storage/backend-resources/vendor/datatables/css/jquery.dataTables.min.css') }}"
        rel="stylesheet">
    <!--swiper-slider-->
    <link rel="stylesheet" href="{{ asset('storage/backend-resources/vendor/swiper/css/swiper-bundle.min.css') }}">
    <!-- Style css -->
    <link href="https://fonts.googleapis.com/css2?family=Material+Icons" rel="stylesheet">
    <link href="{{ asset('storage/backend-resources/css/style.css') }}" rel="stylesheet">
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('storage/backend-resources/images/avatar/1.jpg') }}"
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('storage/backend-resources/images/avatar/2.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('storage/backend-resources/images/avatar/3.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('storage/backend-resources/images/avatar/4.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('storage/backend-resources/images/avatar/5.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media me-2">
                                                        <img alt="image" width="50"
                                                            src="{{ asset('storage/backend-resources/images/avatar/1.jpg') }}">
                                                    </div>
                                ...
                                <div class="dropdown header-profile2">
                                    <a class="nav-link ms-0" href="javascript:void(0);" role="button"
                                        ...
                                        <div class="header-info2 d-flex align-items-center">
                                            ...
                                            <img src="{{ asset('storage/backend-resources/images/user.jpg') }}"
                                                alt="">
                                        </div>
                                    </a>
                    ...
                    <div class="card bg-transparent mb-1">
                        ...
                        <div class="card-body height450 dlab-scroll loadmore-content recent-activity-wrapper p-3 pt-2"
                            ...
                            <div class="d-flex align-items-center student">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/profile/small/pic1') }}.jpg"
                            ...
                            <div class="d-flex align-items-center student">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/profile/small/pic2') }}.jpg"
                                        alt="" width="50" class="avatar">
                                </span>
                                <div class="user-info">
                            ...
                            <div class="d-flex align-items-center student">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/profile/small/pic3') }}.jpg"
                                        alt="" class="avatar">
                                </span>
                                <div class="user-info">
                            ...
                            <div class="d-flex align-items-center student">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/profile/small/pic4') }}.jpg"
                                        alt="" class="avatar">
                                </span>
                                <div class="user-info">
                            ...
                            <div class="d-flex align-items-center student">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/profile/small/pic5') }}.jpg"
                                        alt="" class="avatar">
                                </span>
                                <div class="user-info">
                        ...
                        <div class="card-footer text-center border-0 pt-0 px-3 pb-0">
                            <a href="javascript:void(0);"
                                class="btn btn-block btn-primary light btn-rounded dlab-load-more"
                    ...
                    <div class="card massage bg-transparent mb-0">
                        ...
                        <div class="card-footer text-center border-0 px-3 pb-0">
                            <a href="contact.html"
                                ...
                                rel="ajax/message-content.html">View More</a>
                        </div>
                    </div>
                </div>
                <!--/column-->
                    ...
                    <div class="card tags bg-transparent mb-0">
                        ...
                        <div class="card-body  p-3 py-1 ">
                            <div class="card-body-inner food">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/food/pic1.jpg') }}"
                                        alt="" class="avatar">
                                </span>
                                <div class="user-info">
                                    <h5 class="name"><a href="app-profile.html">Beef Steak with Fried Potato</a>
                                    </h5>
                                    <span class="fs-14 font-w400 text-wrap">Lorem ipsum dolor sit</span>
                                </div>
                            </div>
                            <div class="card-body-inner food">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/food/pic2.jpg') }}"
                                        alt="" class="avatar">
                                </span>
                                <div class="user-info">
                            ...
                            <div class="card-body-inner food">
                                <span class="dz-media">
                                    <img src="{{ asset('storage/backend-resources/images/food/pic3.jpg') }}"
                                        alt="" class="avatar">
                                </span>
                                <div class="user-info">
                                    ...
                                    <div class="col-xl-3 col-6">
                                        <div class="content-box">
                                            <div class="icon-box icon-box-xl std-data">
                                                <svg width="25" height="25" viewBox="0 0 30 38"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="col-xl-3 col-6">
                                        <div class="content-box">
                                            <div class="food-data icon-box icon-box-xl bg-dark">
                                                <svg width="23" height="23" viewBox="0 0 28 34"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                ...
                                <table id="example-1" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="{{ asset('storage/backend-resources/images/trans/1.jpg') }}"
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="icon-box icon-box-sm bg-secondary">
                                                        <svg width="16" height="16" viewBox="0 0 18 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="{{ asset('storage/backend-resources/images/trans/2.jpg') }}"
                                                        alt="" class="avatar avatar-sm me-3">
                                                    <h4>Tony Soap</h4>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="{{ asset('storage/backend-resources/images/trans/3.jpg') }}"
                                                        alt="" class="avatar avatar-sm me-3">
                                                    <h4>Jordan Nico</h4>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="{{ asset('storage/backend-resources/images/trans/4.jpg') }}"
                                                        alt="" class="avatar avatar-sm me-3">
                                                    <h4>Karen Hope</h4>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="trans-list">
                                                    <img src="{{ asset('storage/backend-resources/images/trans/5.jpg') }}"
                                                        alt="" class="avatar avatar-sm me-3">
                                                    <h4>Nadila Adja</h4>
                                                </div>
                                            </td>
 ...
 ***********************************-->
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('storage/backend-resources/vendor/global/global.min.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/vendor/chart.js/Chart.bundle.min.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}">
    </script>
    <!-- Apex Chart -->
    <script src="{{ asset('storage/backend-resources/vendor/apexchart/apexchart.js') }}"></script>
    <!-- Chart piety plugin files -->
    <script src="{{ asset('storage/backend-resources/vendor/peity/jquery.peity.min.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/vendor/jquery-nice-select/js/jquery.nice-select.min.js') }}"></script>
    <!--swiper-slider-->
    <script src="{{ asset('storage/backend-resources/vendor/swiper/js/swiper-bundle.min.js') }}"></script>


    <!-- Datatable -->
    <script src="{{ asset('storage/backend-resources/vendor/datatables/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/js/plugins-init/datatables.init.js') }}"></script>

    <!-- Dashboard 1 -->
    <script src="{{ asset('storage/backend-resources/js/dashboard/dashboard-1.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/vendor/wow-master/dist/wow.min.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/vendor/bootstrap-datetimepicker/js/moment.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/vendor/datepicker/js/bootstrap-datepicker.min.js') }}"></script>
    <script
        src="{{ asset('storage/backend-resources/vendor/bootstrap-select-country/js/bootstrap-select-country.min.js') }}">
    </script>

    <script src="{{ asset('storage/backend-resources/js/dlabnav-init.js') }}"></script>
    <script src="{{ asset('storage/backend-resources/js/custom.min.js') }}"></script>
