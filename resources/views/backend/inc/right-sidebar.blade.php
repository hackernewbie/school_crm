            ...
            <div class="card tags bg-transparent mb-0">
                ...
                <div class="card-body  p-3 py-1 ">
                    <div class="card-body-inner food">
                        <span class="dz-media">
                            <img src="{{ asset('storage/backend-resources/images/food/pic1.jpg') }}" alt=""
                                class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="card-body-inner food">
                        <span class="dz-media">
                            <img src="{{ asset('storage/backend-resources/images/food/pic2.jpg') }}" alt=""
                                class="avatar">
                        </span>
                        <div class="user-info">
                    ...
                    <div class="card-body-inner food">
                        <span class="dz-media">
                            <img src="{{ asset('storage/backend-resources/images/food/pic3.jpg') }}" alt=""
                                class="avatar">
                        </span>
                        <div class="user-info">
