                    ...
                    <div class="col-xl-12">
                        <div class="page-title flex-wrap">
                            ...
                            <div>
                                ...
                                <a href="{{ route('student.create') }}" target="_blank" class="btn btn-primary">+ New
                                    Student</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check800"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check810"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check820"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check830"
                                                        required="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="trans-list">
                                                <img src="{{ asset('storage/backend-resources/images/trans/6.jpg') }}"
                                                    alt="" class="avatar me-3">
                                                <h4>Johnny Ahmad</h4>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="trans-list">
                                                <img src="{{ asset('storage/backend-resources/images/trans/7.jpg') }}"
                                                    alt="" class="avatar me-3">
                                                <h4>Jack Sally</h4>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check850"
                                                        required="">
                                        ...
                                        <td>
                                            <div class="trans-list">
                                                <img src="{{ asset('storage/backend-resources/images/trans/6.jpg"') }}' alt=""
                                                    class="avatar me-3">
                                                <h4>Johnny Ahmad</h4>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="trans-list">
                                                <img src="{{ asset('storage/backend-resources/images/trans/8.jpg') }}"
                                                    alt="" class="avatar me-3">
                                                <h4>Dakota Farral</h4>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check851"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check90"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check91"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check92"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check93"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check94"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check95"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check96"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check97"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check98"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check99"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check100"
                                                        required="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox me-0 align-self-center">
                                                <div class="custom-control custom-checkbox ">
                                                    <input type="checkbox" class="form-check-input" id="check101"
                                                        required="">
